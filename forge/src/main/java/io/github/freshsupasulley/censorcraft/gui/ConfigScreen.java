...
public class ConfigScreen extends Screen {
	...
	protected void init()
	{
		...
		layout.addChild(Checkbox.builder(Component.literal("Show speech"), font).tooltip(Tooltip.create(Component.literal("Displays live audio transcriptions"))).selected(ClientConfig.showTranscription()).onValueChange((button, value) ->
		{
//			ClientConfig.set(value);
		}).build());
