...
/**
 * VoicechatPlugins aren't sided, so instead of bundling the plugin in {@link ClientCensorCraft}, this is the
 * alternative to prevent a non-fatal error message from appearing in dedicated servers.
 */
