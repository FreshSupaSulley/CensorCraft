...
public abstract class ClientConfig extends ConfigFile {
	
	public static final int MIN_LATENCY = 100, MAX_LATENCY = 5000;
	
	private static ClientConfig CLIENT;
	
	public ClientConfig(Path configFolder)
	{
		super(configFolder, "client");
	...
	public static ClientConfig get()
	{
		if(CLIENT == null)
		{
			throw new IllegalStateException("Tried to access client config before it was initialized");
		}
