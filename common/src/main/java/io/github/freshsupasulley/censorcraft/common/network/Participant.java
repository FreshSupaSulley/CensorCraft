...
import io.github.freshsupasulley.censorcraft.common.plugins.impl.ServerPlayerImpl;
import io.github.freshsupasulley.censorcraft.common.plugins.impl.server.ChatTabooEventImpl;
import io.github.freshsupasulley.censorcraft.common.plugins.impl.server.ServerPunishEventImpl;
...
public class Participant {
	...
	private void runServerPunishment(Punishment option, ServerPlayer player)
	{
		...
		try
		{
			option.punish(new ServerPlayerImpl(player));
		} catch(Exception e)
		{
